      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center w-full">
          <div className="bg-[FFFFFF]-100-100 flex rounded-lg shadow-lg w-8/12 p-2 ">
            <div className=" w-2/2 lg:w-2/12  rounded-2xl overflow-hidden shadow-2xl ">
              <img className="rounded-2xl  mb-1" src={ task} alt="" />
              <div className="items-end  relative">
              </div>
            </div>
            <div className="sm:w-3/4 px-3 flex items-center ">
            
               <h1 className='w-full font-semibold '>Complete Your Task Before Review</h1>
               <div className='justify-end  mr-16 mt-2'>
               <button className='bg-black text-white rounded-xl px-5 py-2' onClick={()=>navigate('/task-upload')}>Task</button>
               </div>
            </div>
     
          </div>
          <div className='bg-white rounded-lg shadow-lg sm:w-2/12 lg:w-1/12 text-center items-center mx-2 p-2 justify-center'>
                 <h1 className='font-bold text-base  lg:text-4xl '>{userData?.week < 10 ? `0${userData?.week}` : userData?.week }</h1>
