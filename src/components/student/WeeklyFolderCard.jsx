...
function WeeklyFolderCard({reviewsData}) {
  ...
  return (<>
    <div className='grid py-10 px-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
      {reviewsData?.map((obj)=>{
        return(
          <div className=" col-span-1 pt-4 m-1 bg-white border mx-2 border-gray-200 rounded-lg  dark:bg-slate-100 dark:border-slate-200 shadow-2xl" onClick={()=>handleClick(obj?._id)}>
