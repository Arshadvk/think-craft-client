...
function TaskCard({data , handleClick , type }) {
  console.log(data);
  return (
    <>
    <div className='grid py-10 px-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
      {data?.map((obj)=>{
       ...
       <div className="flex flex-col items-center px-6 py-3" onClick={()=> handleClick(obj._id)}>
       <img
              ...
              <div className="flex space-x-1 ">
                ...
                >
                  {type === 'domain' ? obj?.name : obj?.week < 10 ? "week 0"+obj?.week : "week "+obj?.week}
