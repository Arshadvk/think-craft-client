      ...
      <div className="flex">
        ...
        <div className="p-4">
          ...
          <div className="flex m-1 items-center">
            ...
            <div
              className={
                weekStatus === "Task Completed"
                  ? "p-1 bg-green-500 w-3 h-3 rounded-3xl m-1 mt-2"
                  : weekStatus === "Task Needs Improvement"
                  ? "p-1 bg-yellow-500 w-3 h-3 rounded-3xl m-1 mt-2"
                  : weekStatus === "Task Critical"
                  ? "p-1 bg-orange-500 w-3 h-3 rounded-3xl m-1 mt-2"
                  : weekStatus === "Week Repeat"
                  ? "p-1 bg-blue-500 w-3 h-3 rounded-3xl m-1 mt-2"
                  : "hidden"
              }
            ></div>
            <h1>{!showInput && weekStatus}</h1>
            {showInput && (
              <select
              ...
              >
                {" "}
                <option value="" className=" font-semibold text-sm ">
                  Select One Option
                </option>
                <option
